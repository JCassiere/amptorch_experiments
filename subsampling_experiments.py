...
def random_subsampling_experiment(scaled_data, title, num_points_desired):
    ...
    outlier_retention = calculate_outlier_retention(scaled_data, random_indices, outlier_cutoff_modifier=2)
    experiment_metadata = {
    ...
    save_experiment(title, random_subsample, experiment_metadata)
...
def kmeans_subsampling_experiment(scaled_data, title, num_points_desired):
    ...
    outlier_retention = calculate_outlier_retention(scaled_data, indices_to_keep, outlier_cutoff_modifier=2)
    experiment_metadata = {
        "experiment_title": title,
        "wallclock_time": wallclock_time,
        "num_points": num_points,
